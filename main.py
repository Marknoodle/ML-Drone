...
#filtered = filter_green(frame)
#cv2.imshow('filtered', filtered)
#cv2.waitKey(0)

#centers, rectangles = find_center(filtered)
#print(centers)
#cv2.imshow('rects', rectangles)
...
#mask = filter_green(img)
#centers, rectangles = find_center(mask)
#cv2.imshow('final', rectangles)
#print(centers)
#cv2.waitKey(0)
#cv2.destroyAllWindows()
...
#destination_point = find_destination_point()
...
#x = destination_point[0] - starting_point[0]
#y = destination_point[1] - starting_point[1]
#pixeldistance = math.sqrt(x ** 2 + y ** 2)
#cmdistance = pixeldistance * 1/295 * 100

#print(f"Starting Point: {starting_point}\n Destination Point: {destination_point}\n Distance to move: {cmdistance}cm")
#live_tracking()
